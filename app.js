	...
	function (msg, model) {
		if (msg.$ === 'CreateTask') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{newTaskDescription: newTask}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$CreateTask = {$: 'CreateTask'};
var $author$project$Main$UpdateNewTaskDescription = function (a) {
	return {$: 'UpdateNewTaskDescription', a: a};
};
...
var $author$project$Main$taskCardView = function (task) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('task-card')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$renderTasks = function (tasks) {
	return $elm$core$List$isEmpty(tasks) ? A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('You don\'t have any tasks yet.\nAdd some and they will appear here.')
					]))
			])) : A2(
		$elm$html$Html$section,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$taskCardView, tasks));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('divide')
							]),
						_List_Nil),
						$author$project$Main$renderTasks(model.tasks)
					]))
			]));
};
